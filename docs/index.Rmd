...
The assignment should be completed in groups that will be defined at the start of the course.
...
- Run four iterations of the kinship model, for details on methods to approximate two-sex models, see Caswell [-@caswell_formal_2022]:
   + One-sex model; time-invariant rates; approximate male kin using GKP factors
   + One-sex model; time-variant rates; approximate male kin using the androgynous assumption
   + Two-sex model; time-invariant rates
   + Two-sex model; time-variant rates; assume demographic stability before 1968
...
Using the model outputs, answer:
   ...
   1. List three research questions that you would like to answer using empirical kinship data or kinship models. Be as specific as possible.
