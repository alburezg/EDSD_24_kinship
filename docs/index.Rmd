...
#### 3. What if we want to work with other countries?

(Unfortunelity is not working, but for your information)
...
Download data from the country of interest and build the 'Keyfitz' kinship diagram for a Focal girl aged 5 yo. Compare the result with the one we saw for Sweden.
